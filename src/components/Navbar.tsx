...
export const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Use IntersectionObserver for active section tracking - much more performant
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
            <span className="text-xs">FH</span>
          </div>
          <span className="hidden sm:inline">Favour Harden</span>
        </motion.a>
          ...
          {navItems.map((item, idx) => (
            <motion.a
              ...
              className={cn(
                ...
                activeSection === item.href.substring(1) ? "text-blue-400" : "text-gray-400"
              )}
            >
              {item.name}
            </motion.a>
