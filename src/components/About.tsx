...
import { User, Target, Zap, TrendingUp, Users } from "lucide-react";

const stats = [
  { label: "Years Experience", value: "3+", icon: <Zap className="w-4 h-4" /> },
  { label: "Projects Contributed", value: "10+", icon: <Target className="w-4 h-4" /> },
  { label: "Community Growth", value: "50k+", icon: <TrendingUp className="w-4 h-4" /> },
  { label: "Active Engagement", value: "85%", icon: <Users className="w-4 h-4" /> },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative h-full w-full rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 flex flex-col items-center justify-center text-center">
              <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 mb-6 flex items-center justify-center text-4xl font-bold text-white shadow-2xl shadow-blue-500/20">
                FH
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Favour Harden</h3>
              <p className="text-blue-400 font-medium mb-6">Web3 Community & Growth Strategist</p>
